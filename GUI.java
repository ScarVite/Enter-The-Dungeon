...
public class GUI extends JPanel {
	...
	static int x;
	static int y;
	static int ym = screenheight/2, ysm = screenheight/2; // Die Ysm und Xsm sind zum Schuss testen gewesen kann man also entfernen
	static int xm = screenwidth/2, xsm = screenwidth/2;
	static Label Label1;
